...
const Immigration = ({ navigation, BookingReducer }) => {
                            ...
                            <>
                                <TouchableOpacity
                                    ...
                                    <View style={{ flexDirection: "row", justifyContent: "space-between" ,width:"100%",backgroundColor:"white"}}>
                                        ...
                                        <View style={{width:"25%",alignSelf:"center",justifyContent:"flex-end"}}>
                                        {
                                    ...
                                    <View
                                        ...
                                        <Text
                                            ...
                                            {item.bookingDetails?.first_name}
                                        </Text>
                                    </View>
                                    <View
                                        style={{
                                        ...
                                        <Text
                                            ...
                                            {item.bookingDetails?.middle_name}
                                        </Text>
                                    </View>
                                    <View
                                        style={{
