...
const Immegration = ({ navigation, Homestate }) => {
                            ...
                            Homestate?.length > 0 ? (
                                <>
                                    <View style={{ marginTop: 20 }}>
                                        <Text style={StylesGloble.font20700000000}>{t('Immigration Services')}</Text>
                                    </View>
                                    ...
                                    <FlatList
                                        ...
                                        renderItem={({ item }) => (
                                            <Servicescard navigation={navigation} type={1} data={item} />
                                        )}
                                    />
                                </>
