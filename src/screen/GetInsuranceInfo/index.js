...
const GetInsuranceInfo = ({ navigation }) => {
const insets = useSafeArea();

    const dispatch = useDispatch();
    const { t, i18n } = useTranslation();

    const Insurancedata = useSelector((state) => state.InsuranceInfolistReducer.data);
    console.log('Insurancedata____________',Insurancedata);
    ...
    const DeleteInsurance = () => {
        let url = `travel/insurance/${insuranceid}?lang=${SelectlanguageReducer}`
        setloading(true);
    ...
    showskeleton == 1 ? (
        ...
        <>
                                ...
                                <TouchableOpacity style={{ borderWidth: 1, borderColor: "#E7E7E7", marginTop: 15, padding: 10, borderRadius: 10 }}>
                                    <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                        ...
                                        <View style={{ flexDirection: "row", alignSelf: "center", }}>
                                            <TouchableOpacity style={{ marginRight: 5 }} onPress={() => navigation.navigate('EditInsuranceInfo', { insuranceid: item.id, provider: item.provider, emergency_contact: item.emergency_contact, policy_number: item.policy_number, coverage: item.coverage })}>
                                                <Editdoc />
                                            </TouchableOpacity>
                                            <TouchableOpacity style={{ marginLeft: 5 }} onPress={() => {setdeletmodal(true);setinsuranceid(item.id) }}>
                                                <Deletedoc />
                                            </TouchableOpacity>
                                        </View>
                                    </View>
            ...
            <View style={{ position: "absolute", bottom: 10, alignSelf: "center" }}>
                <TouchableOpacity style={{ alignSelf: 'center' }} onPress={() => navigation.navigate('AddInsuranceInfo')}>
                    <Plusicom />
                </TouchableOpacity>
            </View>
        </>
        ...
        <View
            ...
            <View
                ...
                <View
                    ...
                    <TouchableOpacity onPress={() => {setdeletmodal(false);DeleteInsurance()}}>
                        <LinearGradient
